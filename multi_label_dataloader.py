...
model.to(device)
model.train()
#model.load_state_dict(torch.load('/home/jjvyas1/convnext_weights_224_1e_5_bs16_pretrained.pth'))
#print('after model')
num_epochs = 20
...
for epoch in tqdm(range(num_epochs)):
    ...
    torch.save(model.state_dict(), 'pretrained_convnext_weights_224_1e_5_bs16_22oct.pth')
    print('Model Saved')
